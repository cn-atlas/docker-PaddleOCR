...
RUN tar xf /opt/PaddleOCR/inference/ch_ppocr_server_v1.1_rec_infer.tar -C /opt/PaddleOCR/inference

ADD https://paddleocr.bj.bcebos.com/20-09-22/server/det/ch_ppocr_server_v1.1_det_infer.tar /opt/PaddleOCR/inference
RUN tar xf /opt/PaddleOCR/inference/ch_ppocr_server_v1.1_det_infer.tar -C /opt/PaddleOCR/inference
